...
color   background_c=color(80,65,39);       //背景色
*/
//白バック黒文字

color   text_c      =color(40,24,24);      //文字色
color   background_c=color(255,255,255);       //背景色

//255,87,176
String  font_name   ="DFHSMaruGothicStdN-W4.otf"; //使用するフォントの名前
int     font_size   =60;                      //使用するフォントのサイズ
String  csv_name    ="Karin_text_products_questionAns.csv";//読み込ませるcsvファイルの名前
